...
# ============================================================
# L1-3b: edge case：全部 dead（且 obs 必為 0）
# ============================================================
@pytest.mark.parametrize("threads", [2, 8, 16])
...
# ============================================================
# 新增 1) 必走 captured 分支（done / reward 分支）
# ============================================================
def _init_force_capture(env: PacmanEnv):
    # 把 pacman 固定在中心，ghost[0] 直接放到同格，第一步必抓到
    env.pac_x = env.w // 2
    env.pac_y = env.h // 2
...
# ============================================================
# 新增 3) pacman_speed 分支：0/1/2 都要 threads-invariant
# ============================================================
...
# ============================================================
# 新增 4) 多 seeds：避免只在單一 seed 沒踩到 bug
# ============================================================
...
# ============================================================
# 新增 5) stress test：大 n_agents + 多 steps（抓 rare race / 越界）
# ============================================================
